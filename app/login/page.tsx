          ...
          <div className="relative p-10 lg:p-16 flex flex-col justify-center overflow-hidden bg-primary/5">
            ...
            >
              ...
              <div className="space-y-6">
                {[
                  { title: "Manage Donations", desc: "Keep track of your past and scheduled donations." },
                  { title: "Profile Updates", desc: "Keep your medical information up to date." },
                  { title: "Exclusive Rewards", desc: "Unlock badges and rewards for your contributions." }
                ].map((item, i) => (
          ...
          <div className="p-8 lg:p-16 flex items-center justify-center bg-card/60">
            ...
            >
              <div className="text-center mb-10">
                <h2 className="text-3xl font-black text-foreground mb-3">Sign In</h2>
                <p className="text-muted-foreground font-medium">Don't have an account? <Link href="/signup" className="text-primary font-bold hover:underline transition-all">Create one here</Link></p>
              </div>
              ...
              <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="flex items-center gap-2 px-1">
                  ...
                  <label htmlFor="remember" className="text-sm font-medium text-muted-foreground cursor-pointer">Remember me for 30 days</label>
                </div>
